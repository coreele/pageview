...
目标分支: main
文档影响: 已归档至 `workflow/docs/archive/2026/fix-dev-web-page-core/`（`dev-notes.md`、`qa-report.md`）；含 `page-core` 入口改为 `./src/index.ts` 与 README Run 说明。

> 权威工作流、门禁与状态说明见 [workflow/README.md](../../README.md)。
> 活跃状态见 [STATUS.md](STATUS.md)。
>
> 文档路径（已归档）：`workflow/docs/archive/2026/fix-dev-web-page-core/`。
...
- 2026-07-27：用户同意继续处理「待合入」收尾（「ok」）。核验：`3e789ff` 已在 `main`；源分支无独有提交；**跳过重复合入**；归档至 `workflow/docs/archive/2026/fix-dev-web-page-core/`。归档提交 `beab0e4`；`git push origin main` **失败**（连 GitHub 443 失败）；本地 ahead，待补 push。
