...
- 依据 Spec: **N/A**（fast，Spec 门禁 `skipped`；以 [工作项记录](../../manager/oid-numeric-guard.md) 登记范围为依据：index-viewer QA DEF-2（Low）与 Review F1 —— 非数字 oid 返回误导性 400 `BAD_LSN` + WAL nextStep）
...
- [Git 协作](../../standards/git.md)（源 `oid-numeric-guard` → 目标 `main`）
...
- **触碰路径**: `README.md`、`README.zh-CN.md`、`workflow/docs/features/oid-numeric-guard/dev-notes.md`
...
| `workflow/docs/features/oid-numeric-guard/dev-notes.md` | T5 | 新建 |
