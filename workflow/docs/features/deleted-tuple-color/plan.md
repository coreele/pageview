...
- 依据 Spec: `workflow/docs/features/deleted-tuple-color/spec.md`
...
- [Git 协作](../../standards/git.md)（源 `deleted-tuple-color` → 目标 `main`）
- [质量与验证](../../standards/quality.md)
- [安全](../../standards/security.md)（无新认证/输入面；禁止提交 `.env`/凭据）
- [UI](../../standards/ui.md)（gui 底线：对比可读、选中态可辨）
...
- **触碰路径**: `workflow/docs/features/deleted-tuple-color/dev-notes.md`
- **验收映射**: 全部
...
| `workflow/docs/features/deleted-tuple-color/dev-notes.md` | **新增** |
| `apps/server/**` | **禁止改** |
