...
- `workflow/docs/features/layout-chrome-split/{design,ui-design,plan,dev-notes}.md`（Planner 第四轮修订随分支入库）

未改 `packages/page-core/**`、`apps/server/**`、API；未新增依赖；未提交 `.env` / `workflow/docs/manager/**`。
