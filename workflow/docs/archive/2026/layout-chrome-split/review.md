...
| 工作树 | 未入库：本 `review.md`、`workflow/docs/manager/**`、`.tmp-uicheck/`；实现以分支 commits 为准（`apps/web` + feature 文档已入库） |
| 依据 | `spec.md`（P0-1..15，Q1–Q6 关闭）；`design.md`；`ui-design.md`；`plan.md`（T1–T16）；`dev-notes.md`；`README.md`；`workflow/docs/standards/{documentation,quality,security,git,ui}.md` |
...
| `workflow/docs/standards/ui.md` | 通过 | 主内容优先；徽标可聚焦+title；局部加载指示；light/dark 保留 |
