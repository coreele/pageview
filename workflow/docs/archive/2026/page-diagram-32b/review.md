...
| 工作树 | 未入库：`review.md`、`qa-report.md`、`workflow/docs/manager/**`；**无未提交源码**；实现以 commits 为准 |
| 依据 | `spec.md` P0-12/Q7；`qa-report.md` DEF-001；`dev-notes.md` 修复回执；首轮审阅；`design.md`/`plan.md` T14；`workflow/docs/standards/{quality,security,ui,git,documentation}.md` |
