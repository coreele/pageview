...
- 版本：源分支 `page-diagram-32b` HEAD `7baece2e77b484981d4eaa93d67753d536836062`（领先 `main` 9 commits）。工作树无未提交源码；未入库文档：`review.md`、`dev-notes.md`（改）、`workflow/docs/manager/**`。验收以 commits 为准。
...
| `workflow/docs/standards/ui.md` 底线 | Pass | 焦点/键盘、错误面板、状态反馈可用 |
...
- 版本：源分支 `page-diagram-32b` HEAD `9d828e79f50c6698a059fd6aca5697612757dbca`（领先 `main` 10 commits）。工作树无未提交源码；未入库：`qa-report.md`、`review.md`、`workflow/docs/manager/**`。验收以 commits 为准。
