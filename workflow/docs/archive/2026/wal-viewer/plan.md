...
- 依据 Spec: workflow/docs/features/wal-viewer/spec.md
- 依据 Design: workflow/docs/features/wal-viewer/design.md
- 依据 UI Design: workflow/docs/features/wal-viewer/ui-design.md（`UI 表面: gui`）
- 路径等级: full
...
- 触碰: `README.md`、`README.zh-CN.md`、`workflow/docs/features/wal-viewer/dev-notes.md`
- **T6Δ 完成条件**:
...
| 开发记录 | `workflow/docs/features/wal-viewer/dev-notes.md` |

**不触碰:** `workflow/docs/manager/**`；`packages/page-core` 业务逻辑（除非回归修复）；扩大 Spec 范围。
...
| 类别 | 更新路径或 N/A 理由 |
|---|---|
| 开发文档 | `workflow/docs/features/wal-viewer/dev-notes.md`（本增量验证与偏离） |
