...
| 依据 | `spec.md`（12×P0 + P1-1，approved）；`plan.md`（T1–T9，approved）；`dev-notes.md`；`README.md`；`workflow/docs/standards/{documentation,quality,security,git}.md` |
...
| `workflow/docs/standards/ui.md` | N/A | 无 `ui-design.md`；Design skipped |
