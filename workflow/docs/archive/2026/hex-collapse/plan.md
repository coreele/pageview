...
- 依据 Spec: `workflow/docs/features/hex-collapse/spec.md`（**approved**，2026-07-27 用户「ok」）
...
- **触碰路径**: `styles.css`（若需）、`README.md`、`workflow/docs/features/hex-collapse/dev-notes.md`
- **验收映射**: P1-1；文档影响
...
| `README.md` | 折叠语义文案 |
| `workflow/docs/features/hex-collapse/dev-notes.md` | **新增** |
...
| 类别 | 更新路径或 N/A |
|---|---|
| 开发文档 | `workflow/docs/features/hex-collapse/dev-notes.md`（必做）；代码旁注释仅在非显而易见时 |
