...
> 本工作项的全部产物平铺在 `workflow/archive/2026/chrome-theme-sun/`，无子目录、无版本后缀。
...
- 2026-09-10 FF 合入 `main`（`8033de9..573fa77`，实现 `2a10e02`）并归档至 `workflow/archive/2026/chrome-theme-sun/`。
