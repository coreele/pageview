...
- 依据 Spec: workflow/archive/2026/url-deeplink/spec.md（2026-09-04 用户确认通过，含 4 项裁决：历史粒度 / 编码范围 / 未连接还原 / 失效呈现）
- 依据 Design: workflow/archive/2026/url-deeplink/design.md
- 依据 UI Design: workflow/archive/2026/url-deeplink/ui-design.md（`UI 表面: gui`）
- 路径等级: standard
...
- [git.md](../../../agents/standards/git.md)（源分支 `url-deeplink`；报告/STATUS 提交时机见 §交接顺序）
- [quality.md](../../../agents/standards/quality.md)
- [security.md](../../../agents/standards/security.md)（URL 严禁编码凭据——Spec 合同；无新增 SQL/密钥接触）
...
- 触碰: 无产品代码；`workflow/archive/2026/url-deeplink/dev-notes.md`
...
- 触碰: `README.md`、`README.zh-CN.md`、`workflow/archive/2026/url-deeplink/dev-notes.md`
...
| 文档 | `README.md`、`README.zh-CN.md`、`workflow/archive/2026/url-deeplink/dev-notes.md` |

**不触碰:** `spec.md`、工作项记录、`workflow/archive/2026/**`；`api.ts`、server、page-core、wal-core 及一切 `/api/*` 合同；`HexDump`/`StructureMap`/`WalView`/`HeapPeekOverlay` 等视图组件；主题机制。
...
| 类别 | 更新路径或 N/A 理由 |
|---|---|
| 开发文档 | `workflow/archive/2026/url-deeplink/dev-notes.md`（TDD 证据、手测结论）；`urlState.ts` 顶部参数名公开合同注释（T2 内） |
