...
>
> **前序基线**：`pg-page-viewer`、`page-diagram-32b`、`layout-chrome-split`、`hex-collapse`（归档见 `workflow/archive/2026/`）。本项**仅**修订 Selection detail 中 `t_infomask` / `t_infomask2` 的呈现形态；既有选中联动、hex 高亮、列解码、HOT/ctid、主题等合同**语义保留**，除非本文件显式修订。
>
