...
- 依据 Spec: `workflow/archive/2026/next-page-btn/spec.md`
...
- [git.md](../../../agents/standards/git.md)（源 `next-page-btn` → 目标 `main`）
- [quality.md](../../../agents/standards/quality.md)
- [security.md](../../../agents/standards/security.md)（无新端点/认证；禁止提交 `.env`/凭据）
- [ui.md](../../../agents/standards/ui.md)（gui：焦点可见、disabled 可感知；不新增主题）
...
- **触碰路径**: `workflow/archive/2026/next-page-btn/dev-notes.md`
- **验收映射**: 全部
...
| `workflow/archive/2026/next-page-btn/dev-notes.md` | **新增** |
