...
未改: `workflow/archive/2026/**`、`page-core` 业务逻辑、Spec/Design/Plan、`qa-report.md`、`review.md`。
...
变更：`apps/web/src/{App,WalView}.{tsx}`、`styles.css`；本文件；`workflow/STATUS.md` / `workflow/archive/2026/wal-viewer/main.md`（Manager 已改，本角色未改写）。排除：`_qa-*`、`test-results/`、`sparse.*` fixtures、`review.md`、`qa-report.md`。
