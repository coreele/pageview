...
| 依据 | `spec.md`（12×P0 + P1-1，approved）；`plan.md`（T1–T9，approved）；`dev-notes.md`；`README.md`；`workflow/agents/standards/documentation.md`、`workflow/agents/standards/quality.md`、`workflow/agents/standards/security.md`、`workflow/agents/standards/git.md` |
...
| `workflow/agents/standards/ui.md` | N/A | 无 `ui-design.md`；Design skipped |
