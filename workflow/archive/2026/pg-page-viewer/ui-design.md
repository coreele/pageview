...
> **UI 表面**：gui  
> 依据 Spec：`workflow/archive/2026/pg-page-viewer/spec.md` · 依据 Design：`design.md` · 依据标准：`workflow/agents/standards/ui.md`  
...
- 遵守 `workflow/agents/standards/ui.md`；不以「现代/高级」空词替代分区与状态。
