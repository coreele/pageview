...
- 依据 Spec: workflow/archive/2026/pg-page-viewer/spec.md
- 依据 Design: workflow/archive/2026/pg-page-viewer/design.md
- 依据 UI Design: workflow/archive/2026/pg-page-viewer/ui-design.md（`UI 表面: gui`）
- 路径等级: full
...
- [documentation.md](../../../agents/standards/documentation.md)（若尚未落库，实施期按仓库既有文档约定补齐）
- [quality.md](../../../agents/standards/quality.md)（同上）
- [security.md](../../../agents/standards/security.md)（同上）
- [workflow/agents/standards/ui.md](../../../agents/standards/ui.md)（GUI 底线；细节以 `ui-design.md` 为准）
...
- 触碰: 根 `README.md`、`workflow/archive/2026/pg-page-viewer/dev-notes.md`（实施中由 Developer 维护）
...
| T11 | `README.md`、`workflow/archive/2026/pg-page-viewer/dev-notes.md` |

禁止修改：`spec.md`；`design.md` / `ui-design.md`（除非 Manager 回退 Design）；`workflow/archive/2026/**`（非本实施角色）。
...
| 类别 | 更新路径或 N/A 理由 |
|---|---|
| 开发文档 | `workflow/archive/2026/pg-page-viewer/dev-notes.md`（实施记录）；本 `plan.md`/`design.md`/`ui-design.md` 已存在 |
