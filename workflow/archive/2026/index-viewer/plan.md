...
- 依据 Spec: workflow/archive/2026/index-viewer/spec.md（2026-08-28 用户确认通过，含 5 项裁决）
- 依据 Design: workflow/archive/2026/index-viewer/design.md
- 依据 UI Design: workflow/archive/2026/index-viewer/ui-design.md（`UI 表面: gui`）
- 路径等级: full
...
- [git.md](../../../agents/standards/git.md)（源分支 `index-viewer`；报告/STATUS 提交时机见 §交接顺序）
- [quality.md](../../../agents/standards/quality.md)
- [security.md](../../../agents/standards/security.md)（新增 SQL 仅只读 catalog 查询；无凭据/密钥接触）
...
- 触碰: `README.md`、`README.zh-CN.md`、`packages/page-core/fixtures/README.md`（T2 内）、`workflow/archive/2026/index-viewer/dev-notes.md`
...
| 文档 | `README.md`、`README.zh-CN.md`、`workflow/archive/2026/index-viewer/dev-notes.md` |

**不触碰:** `spec.md`、工作项记录、`workflow/archive/2026/**`；heap 解析语义（`parsePage`/`decode*`）与 `/api/tables/*` 合同；WAL 模式任何文件。
...
| 类别 | 更新路径或 N/A 理由 |
|---|---|
| 开发文档 | `workflow/archive/2026/index-viewer/dev-notes.md`（验证证据、T2 常量冻结记录）；`packages/page-core/fixtures/README.md`（`--index` 捕获步骤与场景表） |
