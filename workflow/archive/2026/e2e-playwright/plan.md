...
- 依据 Spec: N/A（Spec 门禁 skipped——纯测试基础设施，无产品行为/公开接口/错误合同变更；范围以 [main.md](main.md) 为准）
- 依据 Design: workflow/archive/2026/e2e-playwright/design.md
- 路径等级: standard
- Review 门禁: required
...
- [git.md](../../../agents/standards/git.md)（仅 Git 工作区）
...
- 修改：`package.json`（devDeps + scripts）、`pnpm-lock.yaml`、`.gitignore`、`apps/web/vite.config.ts`、`.github/workflows/ci.yml`、`README.md`、`README.zh-CN.md`、`workflow/archive/2026/e2e-playwright/dev-notes.md`
