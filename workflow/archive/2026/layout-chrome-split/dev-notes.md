...
- `workflow/archive/2026/layout-chrome-split/design.md`、`workflow/archive/2026/layout-chrome-split/ui-design.md`、`workflow/archive/2026/layout-chrome-split/plan.md`、`workflow/archive/2026/layout-chrome-split/dev-notes.md`（Planner 第四轮修订随分支入库）

未改 `packages/page-core/**`、`apps/server/**`、API；未新增依赖；未提交 `.env` / `workflow/archive/2026/**`。
