...
- 依据 Spec: `workflow/archive/2026/layout-chrome-split/spec.md`（已确认；Q1–Q6 含第三轮微调已裁决）
- 依据 Design: `workflow/archive/2026/layout-chrome-split/design.md`
- 依据 UI Design: `workflow/archive/2026/layout-chrome-split/ui-design.md`
- 路径等级: full
...
- [git.md](../../../agents/standards/git.md)
- [quality.md](../../../agents/standards/quality.md)
- [security.md](../../../agents/standards/security.md)
...
- **触碰路径**: `workflow/archive/2026/layout-chrome-split/dev-notes.md`、`README.md`（若需）
...
- **完成条件**:
  - 完成下方第四轮定向手测，截图或等价 DOM/布局证据写入 `workflow/archive/2026/layout-chrome-split/dev-notes.md`。
  - 跑通 L2 命令；确认双向高亮、hex 自动滚、Theme、主带唯一切换入口未回退。
  - 确认 scoped diff 无 `packages/page-core/**`、`apps/server/**`；记录未执行项的原因、风险与恢复条件。
- **触碰路径**: `workflow/archive/2026/layout-chrome-split/dev-notes.md`
...
| 允许 | 禁止 |
|---|---|
| `apps/web/src/App.tsx`、`apps/web/src/styles.css`、`workflow/archive/2026/layout-chrome-split/dev-notes.md` | `packages/page-core/**`、`apps/server/**`、改 API 合同、提交 `.env` |
...
| 类别 | 更新路径或 N/A 理由 |
|---|---|
| 开发文档 | `workflow/archive/2026/layout-chrome-split/dev-notes.md`（本轮必更新） |
