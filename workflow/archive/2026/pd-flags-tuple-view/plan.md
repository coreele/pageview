...
- 依据 Spec: `workflow/archive/2026/pd-flags-tuple-view/spec.md`（用户确认 not-required，无业务歧义）
...
- [git.md](../../../agents/standards/git.md)（源 `pd-flags-tuple-view` → 目标 `main`）
...
- **触碰路径**: `workflow/archive/2026/pd-flags-tuple-view/dev-notes.md`
- **验收映射**: 全部
...
| `workflow/archive/2026/pd-flags-tuple-view/dev-notes.md` | **新增** |
| `apps/server/**` | **禁止改** |
...
| 类别 | 更新路径或 N/A |
|---|---|
| 开发文档 | `workflow/archive/2026/pd-flags-tuple-view/dev-notes.md`（必做） |
