...
- **Tree panel** — optional **Show tree / Collapse tree** (same chrome switches as hex/detail; default collapsed). Expand pages on demand; the current block is highlighted; clicking a node loads that page without leaving the structure/hex view
