...
- 依据 Spec: docs/features/pg-page-viewer/spec.md
- 依据 Design: docs/features/pg-page-viewer/design.md
- 依据 UI Design: docs/features/pg-page-viewer/ui-design.md（`UI 表面: gui`）
- 路径等级: full
...
- 触碰: 根 `README.md`、`docs/features/pg-page-viewer/dev-notes.md`（实施中由 Developer 维护）
...
| T11 | `README.md`、`docs/features/pg-page-viewer/dev-notes.md` |

禁止修改：`spec.md`；`design.md` / `ui-design.md`（除非 Manager 回退 Design）；`docs/manager/**`（非本实施角色）。
...
| 类别 | 更新路径或 N/A 理由 |
|---|---|
| 开发文档 | `docs/features/pg-page-viewer/dev-notes.md`（实施记录）；本 `plan.md`/`design.md`/`ui-design.md` 已存在 |
